...
<body class="container d-flex align-items-center justify-content-center bg-primary text-white" style="height: 100vh; flex-direction: column; margin:40px">
    <div class="col-md-6 bg-light rounded p-4" style="color: #010101;00; text-align:center; font-weight:bold;">
